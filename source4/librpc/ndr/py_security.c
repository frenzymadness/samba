...
static PyObject *py_dom_sid_richcmp(PyObject *py_self, PyObject *py_other, int op)
{
	...
	switch (op) {
			case Py_EQ: return val == 0 ? Py_True : Py_False;
			case Py_NE: return val != 0 ? Py_True : Py_False;
			case Py_LT: return val <  0 ? Py_True : Py_False;
			case Py_GT: return val >  0 ? Py_True : Py_False;
			case Py_LE: return val <= 0 ? Py_True : Py_False;
			case Py_GE: return val >= 0 ? Py_True : Py_False;
	}
	Py_INCREF(Py_NotImplemented);
	return Py_NotImplemented;
}
